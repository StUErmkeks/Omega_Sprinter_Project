...
Im zweiten Level gibt es erst zur Mitte ein neues erwähnenswertes Element. In der Mitte dann kommt ein Checkpoint zum Einsatz, damit der Spieler bei einem Tod nicht das ganze Level neu spielen muss. Besonderheit, am Checkpoint ist, dass wenn die Münzen auf Null Fallen wird dieser nicht mehr genutzt und der Spieler respawnt am Levelanfang. \\
...
Falls es in der Zukunft dazu kommen würde an dem Projekt weiter zu arbeiten wäre eine mögliche Erweiterung ein richtiger Boss mit mehreren Leben und noch weiter Gegner-arten, welche auf komplexere Fortbewegung setzten. 

\section{Quellen}
Hauptquelle war diese Online Tutorial:\\
